...
class DeliveryLineItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'product_name', 'quantity_scheduled', 'quantity_delivered',
            'unit', 'notes', 'shortfall', 'is_fully_delivered'
        ]
...
class DeliverySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Delivery
        fields = [
            'id', 'delivery_number', 'invoice_number', 'client_name',
            'status', 'status_display', 'scheduled_date', 'actual_delivery_date',
            'delivery_method', 'tracking_number', 'condition', 'line_items',
            'total_items_scheduled', 'total_items_delivered', 'is_fully_delivered'
        ]
