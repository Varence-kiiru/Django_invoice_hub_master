...
class InvoiceLineItemSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'id', 'description', 'product', 'quantity', 'unit_price', 'line_amount',
            'tax_rate', 'tax_amount', 'line_total', 'notes', 'sort_order'
        ]
...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = [
            'id', 'invoice_number', 'client', 'invoice_date', 'due_date', 'status',
            'description', 'currency', 'subtotal_amount', 'vat_amount', 'total_amount',
            'amount_paid', 'amount_due', 'line_items', 'created_at'
        ]
        read_only_fields = ['subtotal_amount', 'vat_amount', 'total_amount', 'amount_due']
    ...
    def create(self, validated_data):
        ...
        # Recalculate totals
        totals = TaxCalculationService.calculate_invoice_totals(invoice.line_items.all())
    ...
    def update(self, instance, validated_data):
        ...
        totals = TaxCalculationService.calculate_invoice_totals(instance.line_items.all())
