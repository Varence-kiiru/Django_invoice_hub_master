...
urlpatterns = [
    ...
    path('<int:pk>/add-line-item/', views_html.add_line_item_view, name='add-line-item'),
    path('<int:pk>/edit-line-item/<int:line_item_id>/', views_html.edit_line_item_view, name='edit-line-item'),
    path('<int:pk>/remove-line-item/<int:line_item_id>/', views_html.remove_line_item_view, name='remove-line-item'),
    ...
    path('<int:pk>/issue/', views_html.invoice_issue_confirm_view, name='issue'),
