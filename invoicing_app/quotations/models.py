...
class Quote(ActiveModel):
    ...
    quote_date = models.DateField(
        default=timezone.now, db_index=True, help_text="Date quote was prepared"
    )
    valid_until = models.DateField(help_text="Quote expiration date")

    # ━━━ Content ━━━
    description = models.TextField(
        blank=True, null=True, help_text="Quote description/terms"
    )
    ...
    vat_amount = models.DecimalField(
        max_digits=15, decimal_places=2, default=0, help_text="Total VAT"
    )
    total_amount = models.DecimalField(
        max_digits=15, decimal_places=2, default=0, help_text="Subtotal + VAT"
    )

    # ━━━ Metadata ━━━
    issued_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote was formally issued"
    )
    sent_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote was sent to client"
    )
    viewed_at = models.DateTimeField(
        null=True, blank=True, help_text="When client viewed quote"
    )
    accepted_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote was accepted"
    )
    rejected_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote was rejected"
    )
    expired_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote expired"
    )
    converted_at = models.DateTimeField(
        null=True, blank=True, help_text="When quote was converted to invoice"
    )
