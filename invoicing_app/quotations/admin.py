...
class QuoteLineItemInline(admin.TabularInline):
    ...
    model = QuoteLineItem
    extra = 0
    fields = ['product', 'description', 'quantity', 'unit_price', 'tax_rate', 'line_total']
...
class QuoteAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'quote_number', 'client', 'quote_date',
    ...
    readonly_fields = [
        'quote_number', 'created_at', 'updated_at',
        'sent_at', 'viewed_at', 'accepted_at', 'rejected_at',
        'expired_at', 'converted_at'
    ]
    ...
    fieldsets = (
        ...
        ('Client & Dates', {
            'fields': ('client', 'quote_date', 'valid_until')
        }),
        ('Content', {
        ...
        ('Timestamps', {
            'fields': (
                ...
                'rejected_at', 'expired_at', 'converted_at'
            ),
            'classes': ('collapse',)
        }),
        ('Conversion', {
