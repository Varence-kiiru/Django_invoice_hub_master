...
class QuoteForm(forms.ModelForm):
    ...
    class Meta:
        model = Quote
        fields = ["client", "quote_date", "valid_until", "description", "currency"]
        widgets = {
    ...
    class Meta:
        ...
        widgets = {
            ...
            "quantity": forms.NumberInput(
                attrs={"class": "form-control", "step": "0.01", "placeholder": "Qty"}
            ),
...
QuoteLineItemFormSet = inlineformset_factory(
    Quote, QuoteLineItem, form=QuoteLineItemForm, extra=1, can_delete=True
)
