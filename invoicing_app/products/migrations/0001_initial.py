        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of this category", null=True
                    ),
                ),
            ],
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="products_pr_name_863729_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="products_pr_name_992049_idx"),
                    models.Index(
                        fields=["rate_type"], name="products_pr_rate_ty_a9f29d_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, help_text="Product/service name", max_length=255
                    ),
                ),
                (
                    "description",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["tax_class"], name="products_pr_tax_cla_b5e6f7_idx"
                    ),
                    models.Index(
