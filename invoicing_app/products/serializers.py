...
class ProductSerializer(ProductValidationMixin, ValidationMixin, serializers.ModelSerializer):
    """
    ...
    class Meta:
        model = Product
        fields = [
            'id', 'uuid', 'sku', 'name', 'description', 'category', 'category_id', 
            'tax_class', 'tax_class_id', 'unit_price', 'unit', 'is_active',
