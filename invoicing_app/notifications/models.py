...
class EmailTemplate(models.Model):
    ...
    subject = models.CharField(max_length=200, help_text="Email subject template")
    body = models.TextField(
        help_text="Email body template (supports Django template syntax)"
    )
    is_active = models.BooleanField(
        default=True, db_index=True, help_text="Whether this template is active"
    )
...
class NotificationLog(models.Model):
    ...
    entity_type = models.CharField(
        max_length=50, help_text="Entity type (invoice, payment, etc.)"
    )
    ...
    recipient = models.CharField(max_length=255, help_text="Recipient email or phone")
    subject = models.CharField(
        max_length=200, blank=True, null=True, help_text="Email subject or SMS content"
    )
