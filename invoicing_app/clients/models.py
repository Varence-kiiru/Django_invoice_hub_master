...
class Client(ActiveModel):
    ...
    name = models.CharField(
        max_length=255, db_index=True, help_text="Client's business or full name"
    )
    ...
    email = models.EmailField(blank=True, null=True, help_text="Client's primary email")
    phone = models.CharField(
        max_length=20, blank=True, null=True, help_text="Client's primary phone"
    )
    ...
    notes = models.TextField(
        blank=True, null=True, help_text="Internal notes about client"
    )
...
class ClientAddress(models.Model):
    ...
    street_1 = models.CharField(max_length=255, help_text="Street line 1")
    ...
    is_primary = models.BooleanField(
        default=False, help_text="Is this the primary address of this type?"
    )
...
class ClientContact(models.Model):
    ...
    notes = models.TextField(
        blank=True, null=True, help_text="Notes about this contact"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
