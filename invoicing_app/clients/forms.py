...
class ClientForm(forms.ModelForm):
    ...
    class Meta:
        model = Client
        fields = [
            'name', 'email', 'phone', 'client_type', 'tax_id',
            'business_registration_number', 'payment_terms_days', 
...
class ClientAddressForm(forms.ModelForm):
    ...
    class Meta:
        model = ClientAddress
        fields = ['address_type', 'street_1', 'street_2', 'city', 'state_province', 'postal_code', 'country']
        widgets = {
            'address_type': forms.Select(attrs={'class': 'form-control'}),
            'street_1': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Street address'
            }),
            'street_2': forms.TextInput(attrs={
                'class': 'form-control',
