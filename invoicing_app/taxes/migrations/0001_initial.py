    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "effective_from",
                    models.DateField(help_text="When this rate becomes effective"),
                ),
                (
                    "effective_to",
                    models.DateField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["code"], name="taxes_taxra_code_e9f5bd_idx"),
                    models.Index(
                        fields=["tax_type"], name="taxes_taxra_tax_typ_19fc9c_idx"
                    ),
                    models.Index(
                        fields=["effective_from"], name="taxes_taxra_effecti_7b9ffa_idx"
                    ),
                    models.Index(
                        fields=["effective_to"], name="taxes_taxra_effecti_12e87b_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tax_class"], name="taxes_vatru_tax_cla_94797d_idx"
                    ),
                    models.Index(
                        fields=["tax_rate"], name="taxes_vatru_tax_rat_a5ab89_idx"
                    ),
                    models.Index(
                        fields=["priority"], name="taxes_vatru_priorit_c9ad0e_idx"
                    ),
                ],
            },
        ),
