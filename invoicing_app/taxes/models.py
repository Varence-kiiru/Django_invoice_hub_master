...
class TaxRate(models.Model):
    ...
    name = models.CharField(
        max_length=100, help_text="Display name (e.g., 'Standard VAT 16%')"
    )
    ...
    country = models.CharField(
        max_length=100, default="Kenya", help_text="Country this rate applies to"
    )
    ...
    is_vat_applicable = models.BooleanField(
        default=True, help_text="True if VAT can be recovered on purchases"
    )
    ...
    description = models.TextField(
        blank=True, null=True, help_text="Additional details"
    )
...
class VATRule(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(
        max_length=100, help_text="Rule description (e.g., 'Export goods - zero-rated')"
    )
    ...
    is_active = models.BooleanField(
        default=True, db_index=True, help_text="Whether this rule is active"
    )
    created_at = models.DateTimeField(auto_now_add=True)
