...
class LoginHistoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Information", {"fields": ("user", "is_successful")}),
        ("Timing", {"fields": ("login_time", "logout_time")}),
        ("Security & Location", {"fields": ("ip_address", "device_info", "location")}),
        (
            "Technical Details",
            {"fields": ("user_agent", "session_id"), "classes": ("collapse",)},
        ),
    )
