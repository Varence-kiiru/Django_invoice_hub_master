...
class ExpenseAdmin(admin.ModelAdmin):
    """Admin for expenses."""
    list_display = ['description_short', 'get_amount', 'category', 'vendor', 'expense_date', 'status_badge']
    search_fields = ['description', 'reference_number', 'vendor__name']
    list_filter = ['status', 'category', 'expense_date', 'payment_method']
    readonly_fields = ['created_at', 'updated_at', 'submitted_date', 'approved_date', 'paid_date']
    ...
    fieldsets = (
        ...
        ('Dates', {
            'fields': ('expense_date', 'submitted_date', 'approved_date', 'paid_date')
        }),
        ('Payment Details', {
...
class ExpenseBudgetAdmin(admin.ModelAdmin):
    ...
    list_display = ['category', 'monthly_limit', 'get_spent', 'get_remaining', 'budget_status']
