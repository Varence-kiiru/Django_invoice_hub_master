...
class VendorForm(forms.ModelForm):
    ...
    class Meta:
        model = Vendor
        fields = ['name', 'contact_email', 'contact_phone', 'address', 'payment_terms', 'is_active']
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'form-control',
...
class ExpenseForm(forms.ModelForm):
    ...
    class Meta:
        model = Expense
        fields = [
            'description', 'category', 'vendor', 'amount', 'currency',
            'expense_date', 'payment_method', 'status', 'receipt_file',
...
class ExpenseBudgetForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'annual_limit': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': '0.00',
                'step': '0.01',
                'min': '0',
