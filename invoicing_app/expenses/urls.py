...
urlpatterns = [
    ...
    path('vendors/<int:pk>/delete/', views_html.vendors_delete_view, name='vendors-delete'),
    
    # ━━━ Categories ━━━
    path('categories/', views_html.categories_list_view, name='categories-list'),
    path('categories/create/', views_html.categories_create_view, name='categories-create'),
    path('categories/<int:pk>/edit/', views_html.categories_edit_view, name='categories-edit'),
    path('categories/<int:pk>/delete/', views_html.categories_delete_view, name='categories-delete'),
