...
from .models import Subscription, OrganizationMember
...
class PlanEnforcer:
    ...
    def get_invoice_count_this_month(organization):
        ...
        return Invoice.objects.filter(
            created_by_id__in=member_ids, created_at__gte=first_of_month
        ).count()
    ...
    def check_invoice_quota(user):
        ...
        if not organization:
            return {"allowed": False, "reason": "No organization found", "plan": None}
