...
class SignupForm(forms.Form):
    ...
    def clean_password(self):
        ...
        if not re.search(r"[0-9]", password):
            raise ValidationError(
                "Password must contain at least one number.", code="password_no_number"
            )
...
class CompanySetupForm(forms.Form):
    ...
    company_email = forms.EmailField(
        label="Company Email",
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "info@yourcompany.com"}
        ),
    )
    ...
    company_city = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "New York"}
        ),
    )
    ...
    company_postal_code = forms.CharField(
        ...
        max_length=20,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "00100"}),
    )
    ...
    company_tax_id = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "XX-XXXXXXXXX"}
        ),
    ...
    company_registration_number = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "e.g., 123456789"}
        ),
