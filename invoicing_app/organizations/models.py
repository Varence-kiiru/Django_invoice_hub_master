...
class Organization(BaseModel):
    ...
    website = models.URLField(blank=True, null=True, help_text="Organization's website")
    ...
    phone = models.CharField(
        max_length=20, blank=True, null=True, help_text="Organization contact phone"
    )
    ...
    subscription_renew_date = models.DateField(
        blank=True, null=True, help_text="When current subscription renews"
    )
    ...
    enable_api_access = models.BooleanField(
        default=False, help_text="Allow API access for this organization"
    )
    enable_custom_branding = models.BooleanField(
        default=False, help_text="Allow custom company branding (premium feature)"
    )
    enable_advanced_analytics = models.BooleanField(
        default=False, help_text="Enable advanced analytics (premium feature)"
    )
    enable_api_webhooks = models.BooleanField(
        default=False, help_text="Enable webhook notifications (premium feature)"
    )
...
class Subscription(BaseModel):
    ...
    plan = models.CharField(
        max_length=50, help_text="Plan name (free, starter, professional, enterprise)"
    )
    status = models.CharField(
        max_length=20,
    ...
    trial_end = models.DateField(
        blank=True, null=True, help_text="When trial period ends (if applicable)"
    )
    ...
    currency = models.CharField(
        max_length=3, default="USD", help_text="Currency code (USD, EUR, GBP, etc.)"
    )
...
class Invoice(BaseModel):
    ...
    paid_date = models.DateField(
        blank=True, null=True, help_text="When payment was received"
    )

    # Description
    description = models.TextField(
        blank=True, null=True, help_text="Invoice description/line items"
    )
