...
class OrganizationAdmin(admin.ModelAdmin):
    list_display = ['name', 'plan_badge', 'status_badge', 'user_count', 'invoice_count', 'admin_email', 'subscription_started']
    list_filter = ['plan', 'status', 'created_at']
    search_fields = ['name', 'slug', 'admin_email']
    readonly_fields = ['uuid', 'stripe_customer_id', 'stripe_subscription_id', 'api_key', 'created_at', 'updated_at', 'subscription_started']
    ...
    fieldsets = (
        ...
        ('Contact', {
            'fields': ('admin_email', 'phone')
        }),
        ('Subscription', {
            'fields': ('plan', 'status', 'subscription_started', 'subscription_renew_date')
        }),
        ('Billing', {
            'fields': ('stripe_customer_id', 'stripe_subscription_id')
        }),
        ('Usage', {
            'fields': ('user_count', 'invoice_count')
        }),
        ('Features', {
            'fields': ('enable_api_access', 'enable_custom_branding', 'enable_advanced_analytics', 'enable_api_webhooks')
        }),
        ('API', {
            'fields': ('api_key',),
            'classes': ('collapse',)
...
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = ['organization', 'plan', 'status_badge', 'amount', 'current_period_end', 'auto_renew']
...
class BillingInvoiceAdmin(admin.ModelAdmin):
    list_display = ['invoice_number', 'organization', 'amount', 'status_badge', 'due_date', 'issue_date']
