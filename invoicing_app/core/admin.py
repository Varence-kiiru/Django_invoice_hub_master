...
from invoicing_app.core.models import (
    Backup, FAQ, HelpArticle, SupportTicket, CompanySettings, EmailConfiguration, SavedFilter
)
...
class BackupAdmin(admin.ModelAdmin):
    ...
    list_display = ('file_name', 'backup_type', 'status', 'file_size', 'created_at', 'created_by_name')
    ...
    fieldsets = (
        ...
        ('File Details', {
            'fields': ('file_size', 'is_compressed', 'checksum')
        }),
        ('Backup Duration', {
            'fields': ('duration_seconds',)
        }),
        ('Creation', {
            'fields': ('created_by', 'is_automated', 'created_at')
        }),
        ('Restoration', {
    ...
    readonly_fields = ('file_name', 'file_path', 'file_size', 'backup_type', 'status', 'checksum', 
                       'created_by', 'created_at', 'restored_at', 'restored_by', 'is_compressed', 
                       'is_automated', 'notes', 'duration_seconds')
...
class FAQAdmin(admin.ModelAdmin):
    ...
    list_display = ('question', 'category', 'is_active', 'views_count', 'helpful_yes', 'created_at')
    ...
    readonly_fields = ('created_at', 'updated_at', 'views_count', 'helpful_yes', 'helpful_no')


@admin.register(HelpArticle)
class HelpArticleAdmin(admin.ModelAdmin):
    """Help article admin configuration."""
    list_display = ('title', 'category', 'featured', 'is_active', 'views_count', 'created_at')
...
class SupportTicketAdmin(admin.ModelAdmin):
    ...
    list_display = ('ticket_number', 'name', 'subject', 'status', 'priority', 'created_at')
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj:  # Editing existing
            if not request.user.is_superuser:
                readonly.extend(['ticket_number', 'name', 'email', 'subject', 'message'])
        return readonly
...
class CompanySettingsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Financial Settings', {
            'fields': ('default_currency', 'tax_id', 'registration_number', 'bank_account_info')
        }),
        ('Invoice Settings', {
            'fields': ('invoice_prefix', 'invoice_start_number', 'invoice_due_days', 'invoice_notes')
        }),
        ('Payment Settings', {
...
class EmailConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Configuration', {
            'fields': ('smtp_host', 'smtp_port', 'smtp_username', 'smtp_password', 'from_name', 'from_email')
        }),
        ('Status', {
    ...
    readonly_fields = ('last_tested_at', 'last_test_status', 'last_test_error', 'created_at', 'updated_at')

@admin.register(SavedFilter)
class SavedFilterAdmin(admin.ModelAdmin):
    """Saved filter presets admin configuration."""
    list_display = ('name', 'filter_type', 'created_by', 'is_global', 'use_count', 'last_used', 'created_at')
