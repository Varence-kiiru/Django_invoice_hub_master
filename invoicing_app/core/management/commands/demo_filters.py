...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--show-options", action="store_true", help="Show available filter options"
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("🔍 Advanced Search & Filtering Demo"))
    ...
    def _show_filter_options(self, entity_type):
        ...
        self.stdout.write("\n📝 Example filters:")
        self.stdout.write(
            f'  python manage.py demo_filters --type={entity_type} --filter=\'{{"status": "draft"}}\''
        )
        self.stdout.write(
            f'  python manage.py demo_filters --type={entity_type} --search="client name"'
        )
