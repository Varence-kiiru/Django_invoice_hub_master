...
def user_permissions(request):
    ...
    try:
        ...
        context['can_view_expenses'] = (
            check_permission('view_all_expenses') or 
            check_permission('view_own_expenses')
        )
        ...
        context['can_manage_products'] = check_permission('manage_products')  # If exists
        context['can_manage_taxes'] = check_permission('manage_tax_rates')  # If exists
...
def app_version(request):
    ...
    try:
        ...
        return {
            'app_version': '3.0.0',
            'version_name': 'Enterprise Intelligence',
            'api_version': 'v2.0',
        }
