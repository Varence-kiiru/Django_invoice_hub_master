...
urlpatterns = [
    ...
    # ━━━ Payment Management ━━━
    path('reconciliation/', views_html.payment_reconciliation_view, name='reconciliation'),
    ...
    path('<int:pk>/receipt/pdf/', views_html.payment_receipt_pdf_view, name='receipt_pdf'),
    path('<int:pk>/receipt/print/', views_html.payment_receipt_print_view, name='receipt_print'),
    path('<int:pk>/receipt/download/', views_html.payment_receipt_download_view, name='receipt_download'),
    ...
    path('methods/create/', views_html.payment_method_create_view, name='method-create'),
    path('methods/<int:pk>/edit/', views_html.payment_method_edit_view, name='method-edit'),
    path('methods/<int:pk>/delete/', views_html.payment_method_delete_view, name='method-delete'),
]
